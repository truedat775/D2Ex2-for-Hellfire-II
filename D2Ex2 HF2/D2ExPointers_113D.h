...
#else
enum { DDLL_D2CLIENT, DDLL_D2COMMON, DDLL_D2GFX, DDLL_D2LANG, DDLL_D2WIN, DDLL_D2NET, DDLL_D2GAME, DDLL_D2LAUNCH, DDLL_FOG, DDLL_BNCLIENT, DDLL_STORM, DDLL_D2CMP, DDLL_D2MULTI, DDLL_D2SOUND, DDLL_D2GDI, DDLL_D2DDRAW, DDLL_D2DIRECT3D, DDLL_D2GLIDE, DDLL_D2MCPCLIENT };
...
_d2f D2Funcs = {0}; void SetupD2Funcs() {
	...
	EXFUNCPTR(D2CLIENT, D2MenuChange, int, __fastcall, (int iMouseX, int aNull, int iMouseY), 0xC3190) //k
...
void SetupD2Vars() {
		...
		EXVARPTR(D2GFX, fnHelpers, GFXHelpers, 0x10BFC) // table of 7 EXFUNCPTRs
