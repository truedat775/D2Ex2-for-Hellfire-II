...
namespace Misc
{
	...
	void PatchFill(BYTE bInst, DWORD pAddr, DWORD pFunc, DWORD dwLen, char* Type);
	BOOL WriteBytes_II(LPVOID pAddr, VOID * pData, DWORD dwLen);

	void WinSetErrorLevel(int level);
}
#endif
